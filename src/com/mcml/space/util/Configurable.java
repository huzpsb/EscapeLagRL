...
public abstract class Configurable {
    public static void restoreNodes(AzureAPI.Coord<File, FileConfiguration> fileCoord, Class<? extends Configurable> providerClass) throws IllegalArgumentException, IllegalAccessException, IOException {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            ...
            Configurable.Node node = field.getAnnotation(Node.class);
            if (node != null) {
                ...
                if (Modifier.isStatic(mod) && !Modifier.isFinal(mod)) {
                    ...
                    Configurable.View view = field.getAnnotation(View.class);
    ...
    public static AzureAPI.Coord<Object, Object> serializeCollection(Object defaultValue) {
        ...
        if (Set.class.isAssignableFrom(prevType)) {
            combinedEntries = Lists.newArrayList((Object[]) AzureAPI.colorzine(((Set<String>) defaultValue).toArray(new String[0]), String[].class));
    ...
    public static AzureAPI.Coord<Object, Object> deserializeCollection(Object configuredValue, Class<?> targetType) {
        if (Set.class.isAssignableFrom(targetType)) {
            Set<String> fieldValue = (Set) Sets.newHashSet(((List) configuredValue).toArray(new String[0]));
            ...
            ArrayList combinedEntries = Lists.newArrayList(((List) configuredValue).toArray(new String[0]));
            Iterator<String> var4 = combinedEntries.iterator();
