...
public class CancelledPlacementPatch implements Listener {
   ...
   public void place(BlockPlaceEvent evt) {
      if (evt.isCancelled()) {
         ...
         Iterator var4 = player.getNearbyEntities((double)Integer.valueOf((String)radius.get("x")), (double)Integer.valueOf((String)radius.get("y")), (double)Integer.valueOf((String)radius.get("z"))).iterator();
