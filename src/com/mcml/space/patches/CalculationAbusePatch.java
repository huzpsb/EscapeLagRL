...
public class CalculationAbusePatch implements Listener {
   ...
   public void onCommand(PlayerCommandPreprocessEvent evt) {
      ...
      if (command.startsWith("//calc ") && !evt.getPlayer().isOp() && !AzureAPI.hasPerm((CommandSender)evt.getPlayer(), (String)"worldedit.calc")) {
         AzureAPI.log((CommandSender)evt.getPlayer(), Patches.AntiWEcalcWarnMessage);
