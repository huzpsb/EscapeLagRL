...
import com.mcml.space.optimizations.*;
import com.mcml.space.patches.*;
import com.mcml.space.util.*;
...
public class EscapeLag extends JavaPlugin {
    ...
    public static void AutoSetServer(boolean force) throws Throwable {
        try {
    ...
    public boolean setupConfig(String configIdentifier, Class<? extends Configurable> provider) {
        ...
        AzureAPI.Coord<File, FileConfiguration> configCoord = this.configsFile(configIdentifier);
